...
class _PaymentSelectionScreenState extends State<PaymentSelectionScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          'CHECKOUT',
          style: GoogleFonts.poppins(fontWeight: FontWeight.w800, color: onSurface, fontSize: 16, letterSpacing: 1.5),
        ),
        centerTitle: true,
      ),
      body: Column(
        children: [
              ...
              child: Column(
                ...
                children: [
                  ...
                  FadeInAnimation(
                    ...
                    child: _buildOrderSummary(totalAmount, subtotal, tax, isDark, onSurface),
                  ),
          ...
          _buildBottomPayArea(context, isDark),
        ],
      ),
    );
  }

  Widget _buildOrderSummary(double total, double sub, double tax, bool isDark, Color onSurface) {
    return Container(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 14),
          _summaryRow('Service Fee', 'FREE', AppColors.success),
        ],
      ),
    );
  }
  ...
  Widget _summaryRow(String label, String value, Color valueColor) {
    return Row(
      ...
      children: [
        ...
        Text(value, style: GoogleFonts.poppins(fontWeight: FontWeight.bold, color: valueColor, fontSize: 14)),
      ],
    );
  }
  ...
  Widget _buildPaymentMethodsList(bool isDark, Color onSurface) {
    final methods = [
      {'icon': FontAwesomeIcons.applePay, 'name': 'Apple Pay', 'sub': 'Secure Quick Pay'},
      {'icon': FontAwesomeIcons.ccMastercard, 'name': 'Mastercard', 'sub': '**** 4219'},
      {'icon': FontAwesomeIcons.paypal, 'name': 'PayPal', 'sub': 'payngo@cic.edu'},
    ];
  ...
  Widget _paymentCard(int index, IconData icon, String title, String sub, bool isDark, Color onSurface) {
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            if (!isDark && isSelected) BoxShadow(color: AppColors.accent.withOpacity(0.1), blurRadius: 15, offset: const Offset(0, 8))
          ],
        ),
        child: Row(
          children: [
            Container(
              ...
              child: FaIcon(icon, color: isSelected ? AppColors.accent : onSurface.withOpacity(0.4), size: 22),
            ),
            ...
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(title, style: GoogleFonts.poppins(fontWeight: FontWeight.bold, fontSize: 15, color: onSurface)),
  ...
  Widget _buildBottomPayArea(BuildContext context, bool isDark) {
    ...
    return Container(
      ...
      child: RepaintBoundary( // 🚀 عزل الزرار للأداء
        child: CustomButton(
          text: 'CONFIRM & PAY',
